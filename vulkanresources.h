...
*
* Copyright (C) 2015-2022 by Sascha Willems (www.saschawillems.de)
*
...
#undef STR
	...
	inline QString formatFeatureString(const VkFormatFeatureFlags flags)
	{
		switch (flags)
		{
#define STR(r) case VK_FORMAT_FEATURE_##r: return #r
			...
			STR(SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT);
			...
			//STR(SAMPLED_IMAGE_FILTER_CUBIC_BIT_IMG);
			//STR(TRANSFER_SRC_BIT_KHR);
			//STR(TRANSFER_DST_BIT_KHR);
			//STR(SAMPLED_IMAGE_FILTER_MINMAX_BIT_EXT);
			//STR(MIDPOINT_CHROMA_SAMPLES_BIT_KHR);
			//STR(SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR);
			//STR(SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR);
			//STR(SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR);
			//STR(SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR);
			//STR(DISJOINT_BIT_KHR);
			//STR(COSITED_CHROMA_SAMPLES_BIT_KHR);
#undef STR
		default: return "UNKNOWN_ENUM (" + QString::fromStdString(toHexString(flags)) + ")";
		}
	}

	inline QString formatFeature2String(const VkFormatFeatureFlags2 flags)
	{
		switch (flags)
		{
