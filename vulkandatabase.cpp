...
QString VulkanDatabase::databaseUrlSecure = "https://vulkan.gpuinfo.org/";
...
{
	QString urlstr;
	QTextStream urlss(&urlstr);
	urlss << databaseUrl << "api/v3/getreportid.php?"
...
#endif
	QString url = encodeUrl(urlstr);
	QString reply = httpGet(url);
